...
public class RandomNameUtil {
    ...
    private static int sNameLen = 95;  //姓氏数组
    private static int nameLen = 79;  //名字数组
    private static String[] sName = new String[sNameLen];
    private static String[] Name = new String[nameLen];
    ...
    public static void main(String[] args) {
        RandomNameUtil chineseName = new RandomNameUtil();
        int j = 0;
    ...
    public static String getName() {
        ...
        int i = random.nextInt(sNameLen-1);
    ...
    private static String getNameKey() {
        Random random = new Random();
        int i = random.nextInt(nameLen-1);
